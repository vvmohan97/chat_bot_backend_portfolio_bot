...
io.on("connection", (socket) => {
  ...
  socket.on("userMessage", (msg) => {
    ...
    if (
      ...
      reply = "📞 +91-9524244117"; // ✅ Fixed: previously returned email
    } else if (cleanedMsg.includes("instagram")) {
      reply =
        "📷 Instagram: https://www.instagram.com/call_me_v.v.mohan?igsh=MTBudm5sYjZ4Ym1taA==";
    } else if (cleanedMsg.includes("linkedin")) {
      reply = "🔗 LinkedIn: https://www.linkedin.com/in/vvmohankumar-vv/";
    } else if (cleanedMsg.includes("github")) {
      reply = "💻 GitHub: https://github.com/vvmohan97";
    }
